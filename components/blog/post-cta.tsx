    ...
    <Card className="mt-8 border-2 border-purple-500 dark:border-purple-600 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30">
      <CardContent className="py-12 px-8 text-center">
        <h2 className="text-3xl font-bold mb-4 text-gray-900 dark:text-white">
          US Tide Forecast - Real-Time NOAA Tide Predictions & Charts
        </h2>
        <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
          Access accurate tide predictions and charts for major coastal
          locations across the United States. Real-time tide data from NOAA
          including high tide, low tide times, and tide height forecasts.
        </p>
        <Link
          href="/"
