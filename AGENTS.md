...
Serena provides powerful code editing capabilities for this project. When using Serena tools:

### Key Principles
- **Always read files before editing** - Use read_file or other file reading tools first
- **Use exact matching** - Copy text exactly including whitespace and indentation
- **Test after changes** - Run tests immediately after modifications
...
- `mcp_serena_read_file` - Read files before editing
